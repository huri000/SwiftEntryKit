...
class PresetsViewController: UIViewController {
    ...
    private func showButtonBarMessage(attributes: EKAttributes) {
        ...
        let okButtonLabel = EKProperty.LabelContent(text: "SHOW ME  This is a really long title that stretches through multiple lines, but this is the purpose", style: okButtonLabelStyle)
        ...
        let buttonsBarContent = EKProperty.ButtonBarContent(with: closeButton, okButton, separatorColor: EKColor.Gray.light, minimumButtonHeight: 60, expandAnimatedly: true)
